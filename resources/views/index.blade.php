...
<head>
		...
		<link href="{{ asset('asset/css/font-awesome.css') }}" rel="stylesheet" media="screen">
		<link href="{{ asset('asset/css/owl.carousel.css') }}" rel="stylesheet" media="screen">
		<link href="{{ asset('asset/css/flexslider.css') }}" rel="stylesheet" media="screen">
		<link href="{{ asset('asset/css/fancySelect.css') }}" rel="stylesheet" media="screen">
	...
	<body>
			...
			<div class="header-bg">
				...
				<div class="main-slider" id="main-slider">
					...
					<ul class="slides">
						...
						<li ><img class="hero" alt="Slide Image"/></li>
						<li ><img class="iero" alt="Slide Image 2"/></li>
					</ul>
		...
		<script src="{{ asset('asset/js/jquery.accordion.js') }}"></script>
		<script src="{{ asset('asset/js/jquery.placeholder.js') }}"></script>
		<script src="{{ asset('asset/js/jquery.fitvids.js') }}"></script>
		<script src="{{ asset('asset/js/gmap3.js') }}"></script>
